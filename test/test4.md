...
### 五、（20分）一家房地产评估公司想对某城市的房地产销售价格 ![](../images/y.png)（元/m2）与地产的评估价值 ![](../images/x1.png)（万元）、房产的评估价值 ![](../images/x2.png)（万元）和使用面积 ![](../images/x3.png)（m2）建立一个模型，以便对销售价格作出合理预测。为此，收集了20栋住宅的房地产评估数据，由统计软件给出的部分回归结果如下（显著性水平为95%）：
